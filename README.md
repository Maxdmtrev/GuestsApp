...
## Общие сведения
В этой проекте мы реализовали работу приложения. Но теперь мы ограничим действия пользователей на нашем сайте, в зависимости от того, являются ли они зарегистрированными пользователями и, если да, то чем они могут пользоваться.

## ТЗ
Веб-приложение "Список гостей".
